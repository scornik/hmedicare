...
class _EncountersClient implements EncountersClient {
  _EncountersClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GetApiV1EncountersIdResponse> getEncounter({
    ...
    final _options = _setStreamType<GetApiV1EncountersIdResponse>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late GetApiV1EncountersIdResponse _value;
    try {
      _value = GetApiV1EncountersIdResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PostApiV1EncountersIdCompleteResponse> completeEncounter({
    ...
    required String xTenantId,
    required String idempotencyKey,
    ApiV1EncountersIdCompleteRequestBody? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<PostApiV1EncountersIdCompleteResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<PostApiV1EncountersIdEnteredInErrorResponse> enterEncounterInError({
    ...
    required String xTenantId,
    required String idempotencyKey,
    EnterEncounterInErrorRequest? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    ...
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _options =
        _setStreamType<PostApiV1EncountersIdEnteredInErrorResponse>(
          Options(method: 'POST', headers: _headers, extra: _extra)
              .compose(
                _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostApiV1EncountersIdEnteredInErrorResponse _value;
    try {
      _value = PostApiV1EncountersIdEnteredInErrorResponse.fromJson(
        _result.data!,
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<PostApiV1EncountersIdInterruptResponse> interruptEncounter({
    ...
    required String xTenantId,
    required String idempotencyKey,
    InterruptEncounterRequest? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<PostApiV1EncountersIdInterruptResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostApiV1EncountersIdInterruptResponse _value;
    try {
      _value = PostApiV1EncountersIdInterruptResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PostApiV1EncountersIdResumeResponse> resumeEncounter({
    ...
    required String xTenantId,
    required String idempotencyKey,
    ApiV1EncountersIdResumeRequestBody? body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<PostApiV1EncountersIdResumeResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<PostApiV1SerialsIdEncounterResponse> startEncounter({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<PostApiV1SerialsIdEncounterResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PostApiV1SerialsIdEncounterResponse _value;
    try {
      _value = PostApiV1SerialsIdEncounterResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
