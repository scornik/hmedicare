...
enum SerialCancelReason {
  ...
  const SerialCancelReason(this.json);

  factory SerialCancelReason.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<SerialCancelReason> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
