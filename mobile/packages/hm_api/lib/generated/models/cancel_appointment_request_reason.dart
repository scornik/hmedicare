...
@JsonEnum()
enum CancelAppointmentRequestReason {
  ...
  const CancelAppointmentRequestReason(this.json);

  factory CancelAppointmentRequestReason.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<CancelAppointmentRequestReason> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
