...
@JsonEnum()
enum ActivateGuardianshipRequestAuthorityScope {
  ...
  const ActivateGuardianshipRequestAuthorityScope(this.json);

  factory ActivateGuardianshipRequestAuthorityScope.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<ActivateGuardianshipRequestAuthorityScope> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
