...
part of 'queue_policy_patch.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QueuePolicyPatch _$QueuePolicyPatchFromJson(Map<String, dynamic> json) =>
    QueuePolicyPatch(
      ...
      dayCloseDisposition: json['dayCloseDisposition'] == null
          ? null
          : DayCloseDisposition2.fromJson(
      ...
      lateArrivalGraceMinutes: (json['lateArrivalGraceMinutes'] as num?)
          ?.toInt(),
      lateArrivalPlacement: json['lateArrivalPlacement'] == null
          ? null
          : QueuePolicyPatchLateArrivalPlacement.fromJson(
...
Map<String, dynamic> _$QueuePolicyPatchToJson(QueuePolicyPatch instance) =>
    <String, dynamic>{
