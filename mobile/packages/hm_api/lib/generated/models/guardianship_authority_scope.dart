...
@JsonEnum()
enum GuardianshipAuthorityScope {
  ...
  const GuardianshipAuthorityScope(this.json);

  factory GuardianshipAuthorityScope.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<GuardianshipAuthorityScope> get $valuesDefined => values.where((value) => value != $unknown).toList();
}
