...
// also tested on 11.4). Override with MARIADB_IMAGES="mariadb:10.6" to run one image.
import { spawnSync } from 'node:child_process';

const images = (process.env.MARIADB_IMAGES ?? 'mariadb:10.6,mariadb:11.4').split(',').map((s) => s.trim());
