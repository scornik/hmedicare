# Data-licensing request: osudpotro

- To: Contact details on https://osudpotro.com (verify before sending)
- From: Hakeemify ({{CONTACT_EMAIL}})
- Status: DRAFT, not sent. Review, fill placeholders, and send manually.
- Why: compliance verdict for this source prohibits automated access or reuse without permission (see `osudpotro.md`).
...
To help doctors find medicines accurately, we would like to request permission to use factual product attributes published on https://osudpotro.com (brand name, generic name, strength, dosage form, manufacturer, pack size and listed price), or a licensed data feed.
...
- Osudpotro would be credited as a catalogue source inside the product, wherever you prefer.
...
চিকিৎসকরা যাতে সঠিকভাবে ওষুধ খুঁজে পান, সেজন্য আমরা https://osudpotro.com-এ প্রকাশিত ওষুধের তথ্যভিত্তিক বৈশিষ্ট্য (ব্র্যান্ড নাম, জেনেরিক নাম, স্ট্রেন্থ, ডোজেস ফর্ম, প্রস্তুতকারক, প্যাক সাইজ ও তালিকাভুক্ত মূল্য) ব্যবহারের অনুমতি, অথবা একটি লাইসেন্সকৃত ডেটা ফিড চাইছি।
...
- প্রোডাক্টের ভেতরে আপনাদের পছন্দমতো স্থানে Osudpotro-কে ক্যাটালগ উৎস হিসেবে উল্লেখ করা হবে।
