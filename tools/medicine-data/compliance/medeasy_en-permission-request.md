# Data-licensing request: medeasy_en

- To: Contact details on https://medeasy.health (verify before sending)
- From: Hakeemify ({{CONTACT_EMAIL}})
- Status: DRAFT, not sent. Review, fill placeholders, and send manually.
- Why: compliance verdict for this source prohibits automated access or reuse without permission (see `medeasy_en.md`).
...
To help doctors find medicines accurately, we would like to request permission to use factual product attributes published on https://medeasy.health (brand name, generic name, strength, dosage form, manufacturer, pack size and listed price), or a licensed data feed.

We have read your terms of use and we have **not** collected data from your website. We would like to work with your permission. In particular:
...
- MedEasy (English) would be credited as a catalogue source inside the product, wherever you prefer.
...
চিকিৎসকরা যাতে সঠিকভাবে ওষুধ খুঁজে পান, সেজন্য আমরা https://medeasy.health-এ প্রকাশিত ওষুধের তথ্যভিত্তিক বৈশিষ্ট্য (ব্র্যান্ড নাম, জেনেরিক নাম, স্ট্রেন্থ, ডোজেস ফর্ম, প্রস্তুতকারক, প্যাক সাইজ ও তালিকাভুক্ত মূল্য) ব্যবহারের অনুমতি, অথবা একটি লাইসেন্সকৃত ডেটা ফিড চাইছি।

আমরা আপনাদের ব্যবহারের শর্তাবলী পড়েছি এবং আপনাদের ওয়েবসাইট থেকে কোনো তথ্য সংগ্রহ **করিনি**। আমরা আপনাদের অনুমতি নিয়েই কাজ করতে চাই। বিশেষভাবে:
...
- প্রোডাক্টের ভেতরে আপনাদের পছন্দমতো স্থানে MedEasy (English)-কে ক্যাটালগ উৎস হিসেবে উল্লেখ করা হবে।
