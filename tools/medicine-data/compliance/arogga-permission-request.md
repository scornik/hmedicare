# Data-licensing request: arogga

- To: info@arogga.com (listed in terms section 2.3.2)
- From: Hakeemify ({{CONTACT_EMAIL}})
- Status: DRAFT, not sent. Review, fill placeholders, and send manually.
- Why: compliance verdict for this source prohibits automated access or reuse without permission (see `arogga.md`).
...
To help doctors find medicines accurately, we would like to request permission to use factual product attributes published on https://www.arogga.com (brand name, generic name, strength, dosage form, manufacturer, pack size and listed price), or a licensed data feed.
...
- Arogga would be credited as a catalogue source inside the product, wherever you prefer.
...
চিকিৎসকরা যাতে সঠিকভাবে ওষুধ খুঁজে পান, সেজন্য আমরা https://www.arogga.com-এ প্রকাশিত ওষুধের তথ্যভিত্তিক বৈশিষ্ট্য (ব্র্যান্ড নাম, জেনেরিক নাম, স্ট্রেন্থ, ডোজেস ফর্ম, প্রস্তুতকারক, প্যাক সাইজ ও তালিকাভুক্ত মূল্য) ব্যবহারের অনুমতি, অথবা একটি লাইসেন্সকৃত ডেটা ফিড চাইছি।
...
- প্রোডাক্টের ভেতরে আপনাদের পছন্দমতো স্থানে Arogga-কে ক্যাটালগ উৎস হিসেবে উল্লেখ করা হবে।
