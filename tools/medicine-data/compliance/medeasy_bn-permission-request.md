# Data-licensing request: medeasy_bn

- To: Same as medeasy_en
- From: Hakeemify ({{CONTACT_EMAIL}})
- Status: DRAFT, not sent. Review, fill placeholders, and send manually.
- Why: compliance verdict for this source prohibits automated access or reuse without permission (see `medeasy_bn.md`).
...
- MedEasy (Bangla) would be credited as a catalogue source inside the product, wherever you prefer.
...
- প্রোডাক্টের ভেতরে আপনাদের পছন্দমতো স্থানে MedEasy (Bangla)-কে ক্যাটালগ উৎস হিসেবে উল্লেখ করা হবে।
